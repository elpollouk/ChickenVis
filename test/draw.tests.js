(function () {
	...
	function initTestbed(expectedImage, width, height) {
	...
	window.Tests.DrawTests = {
		...
		rectDefaultColour: function () {
			initTestbed("data:image/png;base64,");
			draw.rect(1, 1, 98, 48);
			testbed.verify();
		},

		rectRedSmallCanvas: function () {
			initTestbed("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAZCAYAAABzVH1EAAAAWElEQVRYR+3S0QkAMQzDUGf/odsdDIIQdP8OVO/mJS8HvvEhyxQVWQYSRRSBCvhrQWHrs4rU6aChIlDY+qwidTpoqAgUtj6rSJ0OGioCha3PKlKng4ZnRD4PxDHop55MXAAAAABJRU5ErkJggg==", 50, 25);
			draw.rect(0, 0, 100, 100, "red");
			testbed.verify();
		},

		rectStroke: function () {
			initTestbed("data:image/png;base64,");
		...
		clear: function () {
			initTestbed("data:image/png;base64,");
		...
		resizeClear: function () {
			initTestbed("data:image/png;base64,");
			draw.resize(200, 100);
